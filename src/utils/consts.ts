...
export const THEME_STORAGE_KEY = 'jh-react-theme';

export type THEME_CLASS =
	| 'light'
	| 'dark'
	| 'cupcake'
	| 'bumblebee'
...
export interface THEME_PICKER_OPTION {
	name: string;
	class: THEME_CLASS;
	color: string;
}

export const THEME_PICKER_LIST: THEME_PICKER_OPTION[] = [
